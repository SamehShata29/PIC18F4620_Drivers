...
#define TIEMR0_8BIT_REGISTER_MODE       1
#define TIEMR0_16BIT_REGISTER_MODE      0
...
#define TIEMR0_8BIT_REGISTER_MODE_ENABLE()  (T0CONbits.T08BIT = 1)
#define TIEMR0_16BIT_REGISTER_MODE_ENABLE() (T0CONbits.T08BIT = 0)
