...
# 52 "MCAL_Layer/CCP/../Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 13 "MCAL_Layer/CCP/../Interrupt/mcal_internal_interrupt.h" 2
# 15 "MCAL_Layer/CCP/hal_cpp.h" 2

# 1 "MCAL_Layer/CCP/cpp_cfg.h" 1
# 16 "MCAL_Layer/CCP/hal_cpp.h" 2
# 71 "MCAL_Layer/CCP/hal_cpp.h"
typedef enum{
...
Std_ReturnType CCP_Init(const ccp_t *_ccp_obj){
    ...
    if(((void*)0) == _ccp_obj){
        ...
        if(CCP1_INST == _ccp_obj->ccp_inst){
            if(((uint8)0x0C) == _ccp_obj->ccp_inst){
...
Std_ReturnType CCP_IsCompareDataReady(const ccp_t *_ccp_obj, uint8 *_compare_status){
    ...
    if(((void*)0) == _compare_status){
        ...
        if(((uint8)0x01) == PIR1bits.CCP1IF){
            *_compare_status = ((uint8)0x01);
            (PIR1bits.CCP1IF = 0);
        }
        else{
            *_compare_status = ((uint8)0x00);
        }
        ret = (Std_ReturnType)0x01;
    }
    return ret;
