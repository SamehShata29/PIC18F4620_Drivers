...
# 52 "MCAL_Layer/I2C/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h"
typedef enum{
...
static __attribute__((inline)) void I2C_Interrupt_Configurations(const i2c_t *i2c_obj);
...
Std_ReturnType I2C_Init(const i2c_t *i2c_obj){
    ...
    if(((void*)0) == i2c_obj){
        ...
        else if(1 == i2c_obj->i2c_cfg.i2c_SMBus_control){
                (SSPSTATbits.CKE = 1);
        }
